    ...
    <div class="con-div">
        <div class="max-con">
            ...
            <div class="cli-box" style="color: #919191">
                ...
                <select name="" class="select-project" v-model="form.client" style="color: #919191">
                    <option value="new">Select Project</option>
                    <option >Demo</option>
                </select>
                </div>
                <a class="sub-box" @click.prevent="newClient">
