                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7 col-lg-6 order-2 aos-init aos-animate">
                            <div class="text-center">
                                <img src="https://lancer-app.000webhostapp.com/images/svg/coding.svg" class="img img-responsive" height="auto" width="80%">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="text-center">
                                <img src="https://lancer-app.000webhostapp.com/images/svg/undraw_calculator.svg" class="img img-responsive" height="auto" width="80%">
                            </div>
                        </div>
                    </div>
                </div>
