        ...
        <div id="content">
            ...
            <section class="">
                <div class="container-fluid">
                    <h4 class="mt-0 text-primary">COLLABORATORS</h4>
                    <div class="">
                        <div class="">
                            <div class="collaborators_submenu">
                    <a href="#">Over View</a>
                    ...
                    <a href="#">Documents</a>
                        ...
                        <div class="table-responsive">
                            <table class="table colaborate_table table-borderless">
                                <thead>
                                    <tr>
                                        <th scope="col"></th>
...
<style scoped>
    ...
    .collaborators_submenu a {
        color: #fff;
        /* font-size: ; */
            padding: 1.3vw;
        }

        .collaborators_submenu a:nth-child(2) {
            color: #0ABAB5;
        }
        .user_avatar {
            display: flex;
        ...
        table.colaborate_table{
          border-collapse:separate; 
          border-spacing: 0 1em;
        }

        table.colaborate_table tbody tr{
          padding-bottom: 10px !important;
        }

        table.colaborate_table tbody tr td, table.colaborate_table thead tr th {
            max-width: 200px;
            overflow: hidden;
